    ...
    return (
        <div className="mb-2">
            <div className="bloc-div-entreprise">
                <div className="card card-personne">
            ...
            <div className="card mt-4">
                ...
                <div className="card-body div-spacex">
                    ...
                    <p className="card-text"><span className="text-decoration-underline">Résumé</span></p><p>{summary}</p>
                    <p className="card-text"><span className="text-decoration-underline">Nombre {"d'employé"}</span>  : {employees}</p>
                    <p className="card-text"><span className="text-decoration-underline">Adresse </span> : {headquarter_address}</p>
                    <p className="card-text"><span className="text-decoration-underline">Ville </span> : {headquarter_city}</p>
                    <p className="card-text"><span className="text-decoration-underline">Etat </span> : {headquarter_state}</p>
                    <p className="card-text"><span className="text-decoration-underline">Valeur</span> : {valuation} €</p>
